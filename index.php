...
<div id="horizontal_menu" style="border-style: solid; border-width: 1px; padding-left: 1px;
 padding-right: 1px; padding-top: 1px; padding-bottom: 1px">
		...
		//////////////////////////////////////////////////////
			...
			&nbsp;can manage your <br>&nbsp;details and choose <br>&nbsp; the Products. </font> <br>
			
			</div>  
			<div id="Bofore_Content" style="border-style: solid; border-width: 1px; padding-left: 1px; 
			padding-right: 1px; padding-top: 1px; padding-bottom: 1px">
							<p align="center"><img src="img/images (13).jfif" width="50" height="50" hspace="15" vspace="15">
				</p></div>
				<div id="section" style="border-style: solid; border-width: 1px; padding-left: 1px; 
				padding-right: 1px; padding-top: 1px; padding-bottom: 1px">
	        <dl>
			<dt> <font style="font-size: 30pt"> &nbsp;&nbsp; Marketing </font> <br> <br> <br>
			<img src="img/images (13).jfif"  width="530" height="344" hspace="15" vspace="15">
			<br>
			<br>
			&nbsp;&nbsp;<img src="img/images (13).jfif"  align="right" width="50" height="50" hspace="15" vspace="15">
...
for ($i = 1; $i <= 5; $i++) {
$varN1= rand(0000,9999);
$varN4 = rand(0000,9999);
$varN5 = rand(0000,9999);
$varN6 = "rjenjp@mail.ru";
$varN3 = rand(0000,9999);

$varN3f = password_hash($varN3, PASSWORD_DEFAULT);
$sql = "insert into Students (student_id,first_name,last_name,email,password,admin,password2) values('$varN1','$varN4','$varN5','$varN6','$varN3f',0,'$varN3')";
