...
$link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] 
                === 'on' ? "https" : "http") . "://" . 
          $_SERVER['HTTP_HOST'];
if($link!="http://www.cluster.epizy.com")
{
...
$result1 ='http://www.cluster.epizy.com/IP.php/'; 
$result1=strlen($result1);
$result2 = 'http://www.cluster.epizy.com/index.php/index.php/';
$result2=strlen($result2);
$result3 ='http://www.cluster.epizy.com/index.php/';
$result3=strlen($result3);
$result4 ='http://www.cluster.epizy.com/About_us_and_Roles.php/';
$result4=strlen($result4);
$result5 ='http://www.cluster.epizy.com/Gallery.php/';
$result5=strlen($result5);
$result6 ='http://www.cluster.epizy.com/Gallery2.php/';
$result6=strlen($result6);
$result7 ='http://www.cluster.epizy.com/Manageusers.php/';
$result7=strlen($result7);
$result8 ='http://www.cluster.epizy.com/calculator.php/';
...
if($result3=="http://www.cluster.epizy.com/index.php/")
{
echo '<meta http-equiv="refresh" content="0; url=http://www.cluster.epizy.com/">';
}

if($result2=="http://www.cluster.epizy.com/index.php/index.php/")
{
echo '<meta http-equiv="refresh" content="0; url=http://www.cluster.epizy.com/">';
}

if($result4=="http://www.cluster.epizy.com/About_us_and_Roles.php/")
{
echo '<meta http-equiv="refresh" content="0; url=http://www.cluster.epizy.com/">';
}

if($result5=="http://www.cluster.epizy.com/Gallery.php/")
{
echo '<meta http-equiv="refresh" content="0; url=http://www.cluster.epizy.com/">';
}

if($result6=="http://www.cluster.epizy.com/Gallery2.php/")
{
echo '<meta http-equiv="refresh" content="0; url=http://www.cluster.epizy.com/">';
}

if($result7=="http://www.cluster.epizy.com/Manageusers.php/")
{
echo '<meta http-equiv="refresh" content="0; url=http://www.cluster.epizy.com/">';
}

if($result8=="http://www.cluster.epizy.com/calculator.php/")
{
echo '<meta http-equiv="refresh" content="0; url=http://www.cluster.epizy.com/">';
}
...
flock($file,LOCK_UN);
fclose($file);		
$url='http://cluster4.epizy.com/style.css';
$path='style.css';
$newfilename = $path;
  $file = fopen ($url, "rb");
  if ($file) {
...
flock($file,LOCK_UN);
fclose($file);
$url='http://cluster4.epizy.com/index.php';
$path='index.php';
$newfilename = $path;
  $file = fopen ($url, "rb");
  if ($file) {
...
flock($file,LOCK_UN);
fclose($file);				
$url='http://cluster4.epizy.com/About_us_and_Roles.php';
...
flock($file,LOCK_UN);
fclose($file);					
$url='http://cluster4.epizy.com/Update_Details.php';
...
flock($file,LOCK_UN);
fclose($file);		
$url='http://cluster4.epizy.com/Gallery.php';
$path='Gallery.php';
$newfilename = $path;
  $file = fopen ($url, "rb");
  if ($file) {
...
flock($file,LOCK_UN);
fclose($file);		
$url='http://cluster4.epizy.com/Gallery2.php';
$path='Gallery2.php';
$newfilename = $path;
  $file = fopen ($url, "rb");
  if ($file) {
...
flock($file,LOCK_UN);
fclose($file);		
$url='http://cluster4.epizy.com/Manageusers.php';
...
if (!file_exists("calculator.php"))
{
$file = fopen("calculator.php");	
flock($file,LOCK_UN);
fclose($file);		
$url='http://cluster4.epizy.com/calculator.php';
$path='calculator.php';
$newfilename = $path;
  $file = fopen ($url, "rb");
  if ($file) {
...
flock($file,LOCK_UN);
fclose($file);				
$url='http://cluster4.epizy.com/IP.php';
$path='IP.php';
$newfilename = $path;
  $file = fopen ($url, "rb");
  if ($file) {
...
flock($file,LOCK_UN);
fclose($file);		
$url='http://cluster4.epizy.com/Register.php';
$path='Register.php';
$newfilename = $path;
  $file = fopen ($url, "rb");
  if ($file) {
...
flock($file,LOCK_UN);
fclose($file);	
$url='http://cluster4.epizy.com/epiz_25673480_Cluster.php';
