...
<div id="horizontal_menu" style="border-style: solid; border-width: 1px; padding-left: 1px; padding-right: 1px;
 padding-top: 1px; padding-bottom: 1px">
		...
		//////////////////////////////////////////////////////
			...
			echo'&nbsp;&nbsp;&nbsp;&nbsp;
			<ul>
			<li> <font style="font-size: 12pt">  On  <u>comments </u> This page for buy Apple Juice" and/or Orange Juice and/or Black Chocolate Ice Cream and/or Vegetables  </font> </li>
			</ul>';}?>
...
$TotalPrice=$Vegetables+$Orange_Juice+$Black_Chocalate_Ice_Cream+$Apple_Juice;

$dfe="Yura"; $varN8=' "You have bought these/this product(s) Euro" "'.$TotalPrice.'" "Vegetables"  "'.$Vegetables.'" "Orange_Juice"  "'.$Orange_Juice.'" "$Black_Chocalate_Ice_Cream"  "'.$Black_Chocalate_Ice_Cream.'" "Apple_Juice"  "'.$Apple_Juice.'"   ';

$sql9 = "insert into comments (name,comments) values('$dfe','$varN8')";
$items = $dbConnection->prepare("$sql9");
$items->execute();
}
